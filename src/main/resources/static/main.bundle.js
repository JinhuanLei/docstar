...
var AdminpageComponent = /** @class */ (function () {
    ...
    AdminpageComponent.prototype.getRowHeight = function (row) {
        return row.height;
    };
    ...
    AdminpageComponent.prototype.onDocumentSelect = function (event) {
    ...
    AdminpageComponent.prototype.createLists = function () {
        var _this = this;
        ...
        if (this.selected.length > 1) {
            this.http.get("/listdocuments/" + str).subscribe(function (data) {
                // console.log(data);
                resultDocuments = { "documents": data.results };
                _this.ajaxLists(resultDocuments);
                console.log(resultDocuments);
            });
        }
        else {
            this.http.get("/documents/" + str).subscribe(function (data) {
                // console.log(data);
    ...
    AdminpageComponent.prototype.ajaxLists = function (resultDocuments) {
        var _this = this;
        var head = new http_1.HttpHeaders({ 'Content-Type': 'application/json' });
        if (this.selectedList == "create") {
            console.log('Create');
            this.http.post("/docstar/api/v1/list", resultDocuments, { headers: head }).subscribe(function (data) {
                console.log(data);
                _this.loadLists();
            });
        }
            ...
            console.log('Update');
            this.http.get("/docstar/api/v1/list/" + this.selectedList).subscribe(function (data) {
                console.log(data);
                var temp1 = data.documents;
                var temp2 = temp1.concat(resultDocuments.documents);
                data.documents = temp2;
                // console.log(data);
                _this.http.put("/docstar/api/v1/list", data, { headers: head }).subscribe(function (data) {
                    console.log(data);
                });
            });
        }
...
var list_item_component_1 = __webpack_require__("./src/app/list-item/list-item.component.ts");
var routes = [
    ...
    { path: 'listitem', component: list_item_component_1.ListItemComponent }
];
...
var ListItemComponent = /** @class */ (function () {
    function ListItemComponent(http, router, userService) {
        this.http = http;
        this.router = router;
        this.userService = userService;
        this.suser = { "username": "" };
    ...
    ListItemComponent.prototype.ngOnInit = function () {
        ...
        if (this.lid) {
            this.http.get("/docstar/api/v1/list/" + this.lid).subscribe(function (data) {
                ...
                _this.lists = data.documents;
            });
        }
    };
    ListItemComponent.prototype.validateUser = function () {
        var _this = this;
        this.http.get("/docstar/api/v1/user").subscribe(function (data) {
            console.log(data);
            _this.suser = data;
    ...
    ListItemComponent.prototype.logout = function () {
        var _this = this;
        // var LOGOUT_URL = "http://localhost:3000/wordgame/api/logout/v3";
        var LOGOUT_URL = "/docstar/api/v1/logout";
        this.http.post("/docstar/api/v1/logout", {}).subscribe(function (data) {
    ...
    ListItemComponent.prototype.loadUsers = function () {
        var _this = this;
        this.http.get("/docstar/api/v1/users").subscribe(function (data) {
            _this.users = data;
        });
    };
    ListItemComponent.prototype.onReviewerChange = function (event) {
        var _this = this;
        this.reviewer = event;
        this.documentlistObj.reviewer = this.reviewer;
        console.log(this.documentlistObj);
        this.http.put("/docstar/api/v1/list", this.documentlistObj).subscribe(function (data) {
            console.log(data);
            _this.status = true;
        });
    };
    ListItemComponent.prototype.viewDocument = function (event) {
    };
    ListItemComponent.prototype.deleteDocument = function (event) {
        var _this = this;
        console.log(event);
...
var UserinferComponent = /** @class */ (function () {
    ...
    UserinferComponent.prototype.updateUser = function () {
        ...
        console.log(this.user);
        this.http.put("/docstar/api/v1/" + this.user._id, this.user).subscribe(function (data) {
            _this.user = data;
            console.log(data);
